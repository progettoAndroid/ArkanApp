            ...
            rootRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if(dataSnapshot!=null){
                        ...
                        if(Users != null && Users.size()>=1){
                            for(int i=0;i<Users.size() && visualizzato==false;i++){
                                if(Users.get(i) != nickname){
                                    ...
                                    TextView viewnick2 = findViewById(R.id.nick2);
                                    viewnick2.setText(Users.get(i));
                                    TextView viewscore1 = findViewById(R.id.score1);
                                    viewscore1.setText("" + ScoreMio.get(i));
                                    TextView viewscore2 = findViewById(R.id.score2);
                                    viewscore2.setText("" + ScoreAvversario.get(i));
                                }
                        ...
                        Toast.makeText(getApplicationContext(), getApplicationContext().getResources().getString(R.string.errore_risultato)+"3", Toast.LENGTH_SHORT).show();
                    }
                }
